...
from lasagne_wrapper.optimization_objectives import mean_categorical_crossentropy, mean_pixel_binary_crossentropy, \
...
class RefinementStrategy(object):
    ...
    def __init__(self, n_refinement_steps=3, refinement_patience=5, learn_rate_multiplier=0.1):
        """
        Constructor
        """
    ...
    def adapt_learn_rate(self, lr):
        ...
        return self.learn_rate_multiplier * lr
...
class TrainingStrategy(object):
    ...
    def __init__(self, batch_size=100, ini_learning_rate=0.001, max_epochs=100, patience=10, y_tensor_type=T.ivector,
                 ...
                 shuffle_train=True, report_dices=False, use_mask=False, refinement_strategy=None):
        """
        Constructor
        """
